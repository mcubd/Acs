...
public final class DemoUtil {
    ...
    /** Encrypts the input stream using XOR encryption */
    public static InputStream encryptInputStream(InputStream inputStream) throws IOException {
        byte[] buffer = new byte[1024];
        int bytesRead;
        while ((bytesRead = inputStream.read(buffer)) != -1) {
            xorEncrypt(buffer, XOR_ENCRYPTION_KEY);
